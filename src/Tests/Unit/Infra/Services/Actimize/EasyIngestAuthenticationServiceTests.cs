...
namespace Unit.Infra.Services.Actimize;

public class EasyIngestAuthenticationServiceTests
{
    private readonly ActimizeCommonLogs _actimizeCommonLogs = new ActimizeCommonLogs(Substitute.For<ILogger<ActimizeCommonLogs>>());
